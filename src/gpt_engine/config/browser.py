...
def _locale_profile_key_from_geo(geo: typing.Union[dict, None]) -> str:
...
def _build_locale_from_geo(geo: typing.Union[dict, None]) -> dict:
...
def build_browser_environment(geo: typing.Union[dict, None] = None, base_profile: typing.Union[dict, None] = None) -> dict:
...
def pick_browser_profile(geo: typing.Union[dict, None] = None) -> dict:
