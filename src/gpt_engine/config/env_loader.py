...
def _coerce_env_value(raw: str, default, vtype: typing.Union[str, None] = None):
    if vtype is None:
...
def env_value(key: str, default=None, vtype: typing.Union[str, None] = None):
    ensure_loaded()
    raw = os.getenv(key)
...
def env_list(key: str, default: typing.Union[list[str], None] = None) -> list[str]:
    return list(env_value(key, default or [], "list_str_multiline"))


def apply_env_overrides(namespace: dict, schema: dict[str, typing.Union[str], None] = None) -> None:
