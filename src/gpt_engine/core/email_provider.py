...
def release_email(email: str, status: str = "available", note: typing.Union[str, None] = None) -> str:
    """按邮箱实际来源回收状态，返回来源名。"""
    source = resolve_email_source(email)
    if source == "gptmail":
...
def release_email_if_unconsumed(email: str, note: typing.Union[str, None] = None) -> bool:
