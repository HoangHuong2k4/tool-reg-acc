...
def _request(method: str, path: str, *, params: typing.Union[dict, None] = None, json: typing.Union[dict, None] = None):
    try:
...
def get_account_context(email: str) -> typing.Union[MailNestAccount, None]:
...
def _timestamp(item: dict) -> typing.Union[float, None]:
