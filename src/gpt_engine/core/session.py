...
class BrowserSession:
    ...
    def _attach_openai_target_headers_for_url(self, url: str, headers: typing.Union[dict, None]) -> typing.Union[dict, None]:
        """
    ...
    @staticmethod
    def _parse_retry_after(value: typing.Union[str, None]) -> int:
        if not value:
            return 0
