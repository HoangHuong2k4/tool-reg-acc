...
def _codex_result(
    *,
    ...
    callback_url: typing.Union[str, None] = None,
    message: str = "",
) -> dict:
...
def _cpa_request_json(method: str, path: str, body: typing.Union[dict, None] = None) -> dict:
...
def _sub2_codex_request_json(method: str, path: str, body: typing.Union[dict, None] = None) -> dict:
    from config import sub2api as _sub2_cfg
...
def _cpa_request_raw(method: str, path: str, body: typing.Union[dict, None] = None, *, response_type: str = "text"):
...
def find_cpa_codex_auth_file(*, email: str = "", local_filename: str = "") -> typing.Union[dict, None]:
...
def download_cpa_codex_auth_text(*, cpa_name: typing.Union[str, None] = None, email: str = "", local_filename: str = "") -> tuple[str, str, dict]:
    """
...
def _post_json(session: BrowserSession, url: str, payload: dict, referer: str,
               sentinel_header: typing.Union[str, None] = None, so_header: typing.Union[str, None] = None):
...
def _phone_failure_reason(text: str, status_code: typing.Union[int, None] = None) -> str:
...
def _bootstrap_authorize(
    ...
    state: str,
    code_challenge: typing.Union[str, None] = None,
    auth_url: typing.Union[str, None] = None,
) -> None:
    """
...
def _extract_cpa_auth_json(payload: dict) -> typing.Union[dict, None]:
    """
