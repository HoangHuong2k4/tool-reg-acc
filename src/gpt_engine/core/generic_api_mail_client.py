...
def _extract_code(text: str) -> typing.Union[str, None]:
...
def import_from_file(path: typing.Union[str, typing.Union[Path], None] = None) -> tuple[int, int]:
...
def get_account_context(email: str) -> typing.Union[GenericApiEmailAccount, None]:
