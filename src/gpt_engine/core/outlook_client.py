...
_sec_session: typing.Union[dict, None] = None
...
def get_account_context(email: str) -> typing.Union[OutlookAccount, None]:
...
def release_account(email: str, status: str = "available", note: typing.Union[str, None] = None) -> None:
...
def import_outlook_from_file(path: typing.Union[str, typing.Union[Path], None] = None) -> tuple[int, int]:
...
def _is_remote_disabled_error(exc: typing.Union[Exception, str]) -> bool:
    text = str(exc or "")
...
def _ms_token_fatal_reason(account: OutlookAccount) -> typing.Union[str, None]:
...
def _decode_email_header(header_value: typing.Union[str, None]) -> str:
    if not header_value:
        return ""
    out = []
...
def _ms_access_token(
    account: OutlookAccount,
    http: typing.Union[CurlSession, None] = None,
    preferred_kind: typing.Union[str, None] = None,
) -> tuple[str, str]:
...
def _live_imap_access_token(account: OutlookAccount, http: typing.Union[CurlSession, None] = None) -> str:
...
def _fetch_imap_direct_messages(account: OutlookAccount) -> list[dict]:
    ...
    http = _ms_http()
    mail: imaplib.typing.Union[IMAP4_SSL, None] = None
    try:
        try:
...
def _fetch_via(session: CurlSession, protocol: str, account: OutlookAccount) -> list[dict]:
    ...
    - remote: mail.chatai.codes /api/fetch-typing.Union[graph, imap]
...
def fetch_otp_with_account(
    account: OutlookAccount,
    after_ts: typing.Union[float, None] = None,
    max_wait: typing.Union[int, None] = None,
    poll_interval: typing.Union[int, None] = None,
    subject_includes: typing.Union[list[str], None] = None,
    subject_excludes: typing.Union[list[str], None] = None,
    settle_seconds: typing.Union[int, None] = None,
) -> str:
    """
...
def fetch_latest_otp(
    ...
    # settle 状态机
    best_otp: typing.Union[str, None] = None       # 当前看到的最新 OTP
    best_ts: float = 0.0              # 它的邮件时间戳
    best_subject: str = ""
    best_protocol: str = ""
    best_source: str = ""
    settle_until: typing.Union[float, None] = None # 抓到第一封后，等到这个时刻才返回
    last_diag_log = 0.0
...
def _parse_email_ts(item: dict) -> typing.Union[float, None]:
