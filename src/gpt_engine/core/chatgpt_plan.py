...
def _local_proxy_status(proxy: str) -> tuple[bool, bool, typing.Union[str, None]]:
...
def _plan_check_settings(
    ...
    max_attempts: typing.Union[int, None],
    retry_delay: typing.Union[float, None],
...
def _retryable_plan_error(http_status: typing.Union[int, None]) -> bool:
...
def check_account_plan(
    ...
    *,
    ...
    max_attempts: typing.Union[int, None] = None,
    retry_delay: typing.Union[float, None] = None,
) -> dict:
    token = normalize_token(token)
    if not token:
    ...
    last_result: typing.Union[dict, None] = None
