...
_DOMAIN_CACHE: tuple[float, typing.Union[list[str]], None] = None
...
def _base_url(value: typing.Union[str, None] = None) -> str:
...
def _token_path_candidates(path: typing.Union[str, None] = None) -> list[str]:
...
def gen_token(email: typing.Union[str, None] = None, password: typing.Union[str, None] = None, path: typing.Union[str, None] = None, base_url: typing.Union[str, None] = None) -> str:
...
# 兼容旧内部调用名。
def login(username: typing.Union[str, None] = None, password: typing.Union[str, None] = None, path: typing.Union[str, None] = None, base_url: typing.Union[str, None] = None) -> str:
...
def _request(path: str, body: typing.Union[dict, None] = None):
    url = _base_url() + path
    try:
        resp = requests.post(
            url,
...
def _request_raw(method: str, path: str, *, body: typing.Union[dict, None] = None, token: typing.Union[str, None] = None):
    url = _base_url() + path
    headers = {"Accept": "application/json"}
    if token:
...
def _random_local_part(length: typing.Union[int, None] = None) -> str:
...
def get_account_context(email: str) -> typing.Union[CloudMailAccount, None]:
...
def _parse_time(raw) -> typing.Union[float, None]:
...
def fetch_latest_otp(
    ...
    best_otp: typing.Union[str, None] = None
    best_timestamp = float("-inf")
    settle_until: typing.Union[float, None] = None
