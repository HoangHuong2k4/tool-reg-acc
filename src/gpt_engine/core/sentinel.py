...
def generate_fingerprint_data(device_id: str, attempt: int = 1, elapsed_ms: float = 0, profile: typing.Union[dict, None] = None) -> str:
    """
    生成浏览器指纹数据（p字段）。
...
def solve_proof_of_work(seed: str, difficulty: str, device_id: str, max_attempts: int = 500000, profile: typing.Union[dict, None] = None) -> str:
    """
    计算 Proof of Work。
...
def generate_requirements_token(device_id: str, profile: typing.Union[dict, None] = None) -> str:
    """
...
def get_enforcement_token(sentinel_response: dict, seed: str, difficulty: str, device_id: str, profile: typing.Union[dict, None] = None) -> str:
    """
