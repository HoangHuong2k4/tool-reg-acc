...
def _json_post(session: BrowserSession, url: str, payload: dict, referer: str, headers: typing.Union[dict, None] = None):
...
def authenticated_bootstrap(session: BrowserSession, access_token: typing.Union[str, None] = None, *, strict: bool = False) -> None:
