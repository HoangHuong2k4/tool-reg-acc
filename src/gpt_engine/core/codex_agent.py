...
def _agent_headers(access_token: str, env: typing.Union[Any, None] = None) -> dict[str, str]:
...
def _agent_post(url: str, *, access_token: str, payload: dict[str, Any], env: typing.Union[Any, None] = None, timeout: int = 15):
...
def register_agent(
    access_token: str,
    public_key_ssh: str,
    env: typing.Union[Any, None] = None,
    timeout: int = 15,
...
def build_sub2api_account_entry(
    ...
    *,
    proxy_key: typing.Union[str, None] = None,
) -> dict[str, Any]:
...
def upsert_sub2api_account(
    auth_json: dict[str, Any],
    output_path: typing.Union[str, os].PathLike[str],
    *,
    proxy_key: typing.Union[str, None] = None,
) -> dict[str, Any]:
...
def upload_sub2api_account(
    ...
    api_url: str,
    *,
    api_token: typing.Union[str, None] = None,
    ...
    incoming: dict[str, typing.Union[Any], None] = None
...
def create_codex_agent_identity(
    access_token: str,
    output_path: typing.Union[str, None] = None,
