...
def _account_material_line(email: str, row: typing.Union[dict, None] = None) -> str:
...
def _account_copy_line(material_line: str, access_token: str, totp_secret: typing.Union[str, None] = None) -> str:
...
def _append_batch_archive(
    *,
    ...
    email: str,
    access_token: str,
    totp_secret: typing.Union[str, None],
    email_source: typing.Union[str, None],
    proxy_used: typing.Union[str, None],
    extra: dict,
    batch_dir: typing.Union[Path, None],
) -> Path:
...
def setup_2fa(session: BrowserSession, email: str, otp_code: typing.Union[str, None] = None) -> str:
    """
    完整的 2FA 设置流程。
    会触发再发一份邮箱验证码：
...
def save_account_data(
    ...
    output_path: typing.Union[Path, None] = None,  # 兼容老接口，已废弃
