...
class CloakOpenResult:
    ...
    raw: typing.Union[dict, None] = None
...
class CloakElement:
    ...
    def get_attribute(self, name: str) -> typing.Union[str, None]:
        try:
            if self.locator is not None:
...
class CloakSeleniumDriver:
    ...
    def __init__(self, browser: Any, context: typing.Union[Any, None], page: Any):
    ...
    def execute_cdp_cmd(self, cmd: str, params: typing.Union[dict, None] = None) -> Any:
        params = params or {}
        try:
    ...
    def _serialize_args(self, args: tuple[Any, ...]) -> typing.Union[tuple[CloakElement, None], list[Any]]:
        """拆分 Selenium 脚本参数。
...
def _normalize_proxy(proxy: typing.Union[str, None]) -> typing.Union[str, None]:
...
def _detect_cloak_exit_geo(proxy_url: typing.Union[str, None] = None) -> dict:
...
def _build_cloak_locale_options(proxy_url: typing.Union[str, None] = None) -> dict:
...
def build_cloak_driver(proxy: typing.Union[str, None] = None) -> tuple[CloakSeleniumDriver, CloakOpenResult]:
