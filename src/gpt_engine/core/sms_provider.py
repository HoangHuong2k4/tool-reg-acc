...
def _release_h_number(activation_id: str, http: typing.Union[CurlSession, None] = None) -> dict:
...
def release_h_numbers(ids: list[str], http: typing.Union[CurlSession, None] = None) -> dict:
    """批量释放 H 号码。"""
...
def _release_l_number(activation_id: str, http: typing.Union[CurlSession, None] = None) -> dict:
...
def release_l_numbers(ids: list[str], http: typing.Union[CurlSession, None] = None) -> dict:
...
def acquire_number(
    ...
    service: typing.Union[str, None] = None,
...
def set_status(activation_id: str, status: int, http: typing.Union[CurlSession, None] = None) -> str:
    """
    设置激活状态（setStatus）。
        1 = 号码已就绪（短信已发出）
        3 = 等下一条短信（重发）
...
def complete(activation_id: str, http: typing.Union[CurlSession, None] = None) -> None:
...
def cancel(activation_id: str, http: typing.Union[CurlSession, None] = None, background: bool = True) -> None:
    """
