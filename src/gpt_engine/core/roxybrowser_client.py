...
class RoxyOpenResult:
    profile_id: str
    raw: dict
    debugger_address: typing.Union[str, None] = None
    webdriver_url: typing.Union[str, None] = None
    ws_endpoint: typing.Union[str, None] = None
...
def _workspace_id_value() -> typing.Union[str, int]:
...
def _project_id_value() -> typing.Union[str, int]:
...
class RoxyBrowserClient:
    def __init__(self, api_base: typing.Union[str, None] = None, token: typing.Union[str, None] = None):
    ...
    def request(self, method: str, path: str, *, params: typing.Union[dict, None] = None, json_body: typing.Union[dict, None] = None) -> dict:
    ...
    def try_request(self, method: str, path: str, *, params: typing.Union[dict, None] = None, json_body: typing.Union[dict, None] = None) -> tuple[bool, typing.Union[dict, str]]:
    ...
    def create_profile(self, payload: typing.Union[dict, None] = None) -> str:
    ...
    @staticmethod
    def _normalize_profile_id(value: typing.Union[str, None]) -> str:
    ...
    def open_profile(self, profile_id: typing.Union[str, None] = None) -> RoxyOpenResult:
    ...
    def cleanup_profile(self, opened: typing.Union[RoxyOpenResult, None]) -> None:
    ...
    @staticmethod
    def _extract_debugger_address(payload: dict) -> typing.Union[str, None]:
