...
def _thread_alive(thread_id: typing.Union[int, None]) -> bool:
    if not thread_id:
        return False
    try:
        tid = int(thread_id)
...
def run_worker(
    email: str,
    *,
    batch_label: typing.Union[str, None] = None,
    clear_log: bool = True,
    target_log_path: typing.Union[str, typing.Union[Path], None] = None,
) -> dict:
    """执行一次 Codex 补跑。调用前必须先 reserve，结束时会自动 release。"""
    fh: logging.typing.Union[FileHandler, None] = None
