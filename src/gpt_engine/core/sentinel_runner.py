...
def generate_sentinel_token(
    ...
    page_url: typing.Union[str, None] = None,
    browser_profile: typing.Union[dict, None] = None,
    sentinel_sid: typing.Union[str, None] = None,
    react_listening_key: typing.Union[str, None] = None,
    react_container_key: typing.Union[str, None] = None,
    react_resources_key: typing.Union[str, None] = None,
    cookie: typing.Union[str, None] = None,
) -> str:
    """
