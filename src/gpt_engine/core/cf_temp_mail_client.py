...
def _build_headers(*, content_type: bool = False, bearer_jwt: typing.Union[str, None] = None) -> dict[str, str]:
...
def _auth_params(params: typing.Union[dict, None] = None) -> dict:
...
def _generate_local(length: typing.Union[int, None] = None) -> str:
...
def _request(
    ...
    path: str,
    *,
    json_body: typing.Union[dict, None] = None,
    params: typing.Union[dict, None] = None,
    bearer_jwt: typing.Union[str, None] = None,
...
def create_address(domain: typing.Union[str, None] = None) -> CFTempMailAccount:
...
def get_account_context(email: str) -> typing.Union[CFTempMailAccount, None]:
...
def _message_timestamp(item: dict) -> typing.Union[float, None]:
...
def _standalone_otp_from_html(html: str) -> typing.Union[str, None]:
...
def get_message_detail(jwt: str, message_id: str) -> dict:
    ...
    last_error: typing.Union[Exception, None] = None
