...
def _link_type(value: typing.Union[str, None] = None) -> str:
...
def _cdk(value: typing.Union[str, None] = None) -> str:
...
def query_cdk(*, cdk: typing.Union[str, None] = None) -> dict:
    base = _api_base()
    code = _cdk(cdk)
...
def _format_failure_reason(exc: Exception, logs: typing.Union[list[str], None] = None, last_event: typing.Union[dict, None] = None) -> str:
...
def enqueue_account_extract(*, account_id: int, email: str, access_token: str, trigger: str = "manual", link_type: typing.Union[str, None] = None, cdk: typing.Union[str, None] = None) -> dict:
