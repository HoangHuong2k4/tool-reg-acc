...
def _render_static_viewer(outlook_rows: typing.Union[list[dict], None] = None, account_rows: typing.Union[list[dict], None] = None) -> Path:
    """生成可直接双击打开的静态账号查看页。"""
...
def _find_by_email(rows: list[dict], email: str) -> typing.Union[dict, None]:
...
def _account_matches_plan_filter(row: dict, plan_filter: typing.Union[str, None] = None) -> bool:
...
def _decorate_outlook(row: dict, account_by_email: dict[str, typing.Union[dict], None] = None) -> dict:
    out = dict(row)
...
def _decorate_generic_api_email(row: dict, account_by_email: dict[str, typing.Union[dict], None] = None) -> dict:
    out = dict(row)
...
def _row_to_dict(row: typing.Union[dict, None]) -> typing.Union[dict, None]:
...
def insert_account(
    *,
    email: str,
    access_token: str,
    totp_secret: typing.Union[str, None] = None,
    user_id: typing.Union[str, None] = None,
    user_name: typing.Union[str, None] = None,
    plan_type: typing.Union[str, None] = None,
    expires_at: typing.Union[str, None] = None,
    device_id: typing.Union[str, None] = None,
    proxy_used: typing.Union[str, None] = None,
    email_source: typing.Union[str, None] = None,
    extra: typing.Union[dict, None] = None,
    codex_status: typing.Union[str, None] = None,   # success / failed / skipped / missing
    codex_error: typing.Union[str, None] = None,    # 失败原因（仅 codex_status=failed 时有意义）
) -> int:
...
def update_account_codex_status(email: str, codex_status: str, codex_error: typing.Union[str, None] = None) -> bool:
    """
...
def update_account_codex_agent(acc_id: int, result: typing.Union[dict, None] = None) -> bool:
...
def claim_account_plan_check(
    acc_id: typing.Union[int, None] = None,
...
def update_account_plan_check(acc_id: typing.Union[int, None] = None, email: typing.Union[str, None] = None, result: typing.Union[dict, None] = None) -> bool:
...
def update_account_extract(acc_id: int, result: typing.Union[dict, None] = None) -> bool:
    """更新账号提链任务结果/进度。"""
    result = result or {}
    with _LOCK:
        accounts = _load_accounts()
...
def _account_matches_query(row: dict, q: typing.Union[str, None]) -> bool:
...
def _filtered_decorated_accounts(archived: typing.Union[str, typing.Union[bool], None] = False, plan_filter: typing.Union[str, None] = None, q: typing.Union[str, None] = None) -> list[dict]:
    rows = _load_accounts()
...
def list_account_plan_check_statuses(limit: int = 5000, offset: int = 0, archived: typing.Union[str, typing.Union[bool], None] = False, plan_filter: typing.Union[str, None] = None, q: typing.Union[str, None] = None) -> dict:
...
def list_accounts(limit: int = 500, offset: int = 0, archived: typing.Union[str, typing.Union[bool], None] = False, plan_filter: typing.Union[str, None] = None, q: typing.Union[str, None] = None) -> list[dict]:
    with _LOCK:
...
def list_accounts_page(limit: int = 50, offset: int = 0, archived: typing.Union[str, typing.Union[bool], None] = False, plan_filter: typing.Union[str, None] = None, q: typing.Union[str, None] = None) -> dict:
    with _LOCK:
        rows = _filtered_decorated_accounts(archived=archived, plan_filter=plan_filter, q=q)
        total = len(rows)
        limit = max(1, int(limit))
...
def update_accounts_note(account_ids: typing.Union[list[int], None], note: str) -> tuple[list[dict], list[dict]]:
    """
    批量更新已注册账号备注。
...
def archive_accounts(account_ids: typing.Union[list[int], None], archived: bool = True) -> tuple[list[dict], list[dict]]:
...
def delete_account(acc_id: typing.Union[int, None] = None, email: typing.Union[str, None] = None) -> bool:
...
def delete_accounts(account_ids: typing.Union[list[int], None] = None, emails: typing.Union[list[str], None] = None) -> tuple[list[dict], list[dict]]:
    """
    批量删除已注册账号。
...
def import_registered_email_accounts(records: list[dict], source: typing.Union[str, None]) -> tuple[int, int]:
    """
...
def claim_next_outlook() -> typing.Union[dict, None]:
...
def release_outlook(email: str, status: str = "available", note: typing.Union[str, None] = None) -> None:
...
def release_unconsumed_outlook(email: str, note: typing.Union[str, None] = None) -> bool:
...
def list_outlook_pool(status: typing.Union[str, None] = None, limit: int = 500) -> list[dict]:
    with _LOCK:
        account_by_email = {
            (a.get("email") or "").lower(): a
...
def get_outlook_by_email(email: str) -> typing.Union[dict, None]:
    with _LOCK:
...
def claim_next_generic_api_email() -> typing.Union[dict, None]:
...
def release_generic_api_email(email: str, status: str = "available", note: typing.Union[str, None] = None) -> None:
...
def release_unconsumed_generic_api_email(email: str, note: typing.Union[str, None] = None) -> bool:
...
def list_generic_api_email_pool(status: typing.Union[str, None] = None, limit: int = 500) -> list[dict]:
    with _LOCK:
        account_by_email = {
            (a.get("email") or "").lower(): a
            for a in _load_accounts()
...
def get_generic_api_email_by_email(email: str) -> typing.Union[dict, None]:
    with _LOCK:
...
def _new_job_row(
    ...
    *,
    ...
    parent_job_id: typing.Union[int, None] = None,
    root_job_id: typing.Union[int, None] = None,
    retry_attempt: int = 0,
    retry_action: typing.Union[str, None] = None,
    email: typing.Union[str, None] = None,
    account_id: typing.Union[int, None] = None,
) -> dict:
...
def update_job(
    ...
    *,
    ...
    completed_at: typing.Union[str, None] = None,
    account_id: typing.Union[int, None] = None,
) -> None:
    with _LOCK:
        rows = _load_jobs()
...
def get_job(job_id: int) -> typing.Union[dict, None]:
    with _LOCK:
        row = next((r for r in _load_jobs() if int(r.get("id") or 0) == int(job_id)), None)
        return dict(row) if row else None


def get_successful_retry_for_job(job_id: int) -> typing.Union[dict, None]:
...
def _find_domain_email(rows: list[dict], email: str) -> typing.Union[dict, None]:
    target = (email or "").lower()
    return next((r for r in rows if (r.get("email") or "").lower() == target), None)
...
def release_domain_email(email: str, status: str = "available", note: typing.Union[str, None] = None) -> None:
    """更新域名邮箱状态。"""
    with _LOCK:
        rows = _load_domain_pool()
        row = _find_domain_email(rows, email)
...
def release_unconsumed_domain_email(email: str, note: typing.Union[str, None] = None) -> bool:
...
def get_domain_email_by_email(email: str) -> typing.Union[dict, None]:
    with _LOCK:
        row = _find_domain_email(_load_domain_pool(), email)
        return dict(row) if row else None


def list_domain_email_pool(status: typing.Union[str, None] = None, limit: int = 500) -> list[dict]:
    with _LOCK:
